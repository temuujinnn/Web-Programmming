class DatePicker{
    ...
    render(date){
        ...
        this.cont.innerHTML = "<span id=previous>  <img src='left-chevron.png' >  </span>" +  this.cont.innerHTML + "<span id=next>  <img src='right-chevron.png' >  </span> " + "<div class=week> <div>Sun</div>"+"<div>Mon</div>" +" "+"<div>Tue</div>"+" "+ "<div>Wed</div>"+""+"<div>Thur</div>"+""+ "<div>Fri</div>"+" "+ "<div>Sat</div>"+" "+ " </div>";  
        this.odor(date);
